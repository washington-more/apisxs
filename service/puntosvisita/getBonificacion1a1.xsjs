...
try{
    ...
    'case when round(round(('+cantidad+'/T0."U_AB_BUOK"),0,ROUND_DOWN)*T0."U_AB_BUOQ",0,ROUND_DOWN)>T0."U_AB_BUOM" '+
    'then T0."U_AB_BUOM" else '+
    'round(round(('+cantidad+'/T0."U_AB_BUOK"),0,ROUND_DOWN)*T0."U_AB_BUOQ",0,ROUND_DOWN) end '+
    'else 0 end else 0 end as "CantidadBonif", 100 as "Descuento", '+
    'ifnull((select case when T3."Price"=0 then 0.10 else T3."Price" end FROM '+dbname+'.ITM1 T3 where T3."ItemCode"=T0."U_AB_BUOC" and T3."PriceList"=1),0) as "Precio", '+
	...
	'and case when round(round(('+cantidad+'/T0."U_AB_BUOK"),0,ROUND_DOWN)*T0."U_AB_BUOQ",0,ROUND_DOWN)>T0."U_AB_BUOM" '+
    'then T0."U_AB_BUOM" else '+
    'round(round(('+cantidad+'/T0."U_AB_BUOK"),0,ROUND_DOWN)*T0."U_AB_BUOQ",0,ROUND_DOWN) end '+
	'<= '+ 
