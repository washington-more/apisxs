...
try{
    ...
    'case when round(round(('+cantidad+'/T0."U_AB_DTCPC"),0,ROUND_DOWN)*T0."U_AB_DTCQB",0,ROUND_DOWN)>T0."U_AB_DTCQC" '+
    'then T0."U_AB_DTCQC" else '+
    'round(round(('+cantidad+'/T0."U_AB_DTCPC"),0,ROUND_DOWN)*T0."U_AB_DTCQB",0,ROUND_DOWN) end '+
    'else 0 end else 0 end as "CantidadBonif", 100 as "Descuento", '+ 
    'ifnull((select case when T3."Price"=0 then 0.10 else T3."Price" end FROM '+dbname+'.ITM1 T3 where T3."ItemCode"=T0."U_AB_DTCCB" and T3."PriceList"=1),0) as "Precio", '+
    ...
    'where T2."U_AB_BTCA"=\'Y\' and T2."U_AB_BTCM"=\'Y\' and T0."Code"=\''+codigo+'\' and current_date between T2."U_AB_BTCI" and T2."U_AB_BTCF" '+
	...
	'and case when round(round(('+cantidad+'/T0."U_AB_DTCPC"),0,ROUND_DOWN)*T0."U_AB_DTCQB",0,ROUND_DOWN)>T0."U_AB_DTCQC" '+
    'then T0."U_AB_DTCQC" else '+
    'round(round(('+cantidad+'/T0."U_AB_DTCPC"),0,ROUND_DOWN)*T0."U_AB_DTCQB",0,ROUND_DOWN) end '+
	'<= '+ 
    ...
    'from '+dbname+'."@AB_DTCO" T0 inner join '+dbname+'.OITM T1 on T0."U_AB_DTCCB"=T1."ItemCode" '+
	'inner join '+dbname+'."@AB_BCTC" T2 on T0."Code"=T2."Code" '+
    'where T2."U_AB_BTCA"=\'Y\' and T2."U_AB_BTCB"=\'Y\' and T0."Code"=\''+codigo+'\' and current_date between T2."U_AB_BTCI" and T2."U_AB_BTCF" '+
	'and \''+ccliente+'\' in (select ifnull(T3."U_AB_DTCCC",\''+ccliente+'\') from '+dbname+'."@AB_DTCC" T3 where T3."Code"=T2."Code") '+
	'and \''+cove+'\' in (select ifnull(T3."U_AB_DTCCV",\''+cove+'\') from '+dbname+'."@AB_DTCV" T3 where T3."Code"=T2."Code") '+
	'and \''+suc+'\' in (select ifnull(T3."U_AB_DTCCS",\''+suc+'\') from '+dbname+'."@AB_DTCS" T3 where T3."Code"=T2."Code") '+
	'and \''+cond+'\' in (select ifnull(T3."U_AB_DTCCC",\''+cond+'\') from '+dbname+'."@AB_DTCP" T3 where T3."Code"=T2."Code") '+
    ...
    'from '+dbname+'."@AB_DTCO" T0 inner join '+dbname+'.OITM T1 on T0."U_AB_DTCCB"=T1."ItemCode" '+
	'inner join '+dbname+'."@AB_BCTC" T2 on T0."Code"=T2."Code" '+
    'where T2."U_AB_BTCA"=\'Y\' and T2."U_AB_BTCC"=\'Y\' and T0."Code"=\''+codigo+'\' and current_date between T2."U_AB_BTCI" and T2."U_AB_BTCF" '+
	'and \''+ccliente+'\' in (select ifnull(T3."U_AB_DTCCC",\''+ccliente+'\') from '+dbname+'."@AB_DTCC" T3 where T3."Code"=T2."Code") '+
	'and \''+cove+'\' in (select ifnull(T3."U_AB_DTCCV",\''+cove+'\') from '+dbname+'."@AB_DTCV" T3 where T3."Code"=T2."Code") '+
	'and \''+suc+'\' in (select ifnull(T3."U_AB_DTCCS",\''+suc+'\') from '+dbname+'."@AB_DTCS" T3 where T3."Code"=T2."Code") '+
	'and \''+cond+'\' in (select ifnull(T3."U_AB_DTCCC",\''+cond+'\') from '+dbname+'."@AB_DTCP" T3 where T3."Code"=T2."Code") '+
