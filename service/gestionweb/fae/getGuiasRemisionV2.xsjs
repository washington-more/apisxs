...
try{
	...
	'\'info@alvarezbohl.pe\' as "correoremitente",'+
	//'case when ifnull(T2."E_Mail",\'info@alvarezbohl.pe\')=\'\' then \'info@alvarezbohl.pe\' else ifnull(T2."E_Mail",\'info@alvarezbohl.pe\') end as "correodestinatario", '+
	'case '+
        'when ifnull(T2."E_Mail",\'info@alvarezbohl.pe\')=\'\' then \'info@alvarezbohl.pe\' '+
        'when T2."E_Mail" NOT LIKE \'%@%\' then \'info@alvarezbohl.pe\' '+
        'else ifnull(T2."E_Mail",\'info@alvarezbohl.pe\') '+
	'end as "correodestinatario", '+
