...
function ActualizarComprometidos(empresa,numero, est,est2){
    ...
    try{
        ...
        'set "U_AB_DMES"=\''+est+'\',"U_AB_DMMS"=\''+est2+'\' '+
        ' where ("U_SYP_MDSD"||\'-\'||"U_SYP_MDCD"=\''+numero+'\') and "CANCELED"=\'N\'  ';
...
try{
	...
	var estado2 = $.request.parameters.get('estado2');
	...
	if (numeroDoc !== undefined && estado !== undefined )
	{
	    ...
	    //actualizar OV
	    var actualizar = ActualizarComprometidos(dbname,numeroDoc, estado,estado2);
