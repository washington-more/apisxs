...
try{
	...
	{ 
        ...
        query = 'select * from( '+
        'select T0."AcctCode" as "Code",T0."AcctName" as "Name" '+
        'from '+dbname+'.OACT T0 where T0."U_AB_PCSU"=\''+suc+'\' and T0."AcctCode" like \'104%\' '+
        'union all '+
        'select T0."AcctCode" as "Code",T0."AcctName" as "Name" '+
        'from '+dbname+'.OACT T0 where T0."U_AB_PCSU"=\'TD\' and T0."AcctCode" like \'104%\' '+
        ')Q0 order by "Name"';
