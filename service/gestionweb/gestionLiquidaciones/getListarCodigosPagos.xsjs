...
try{
	...
	{ 
        ...
        'from '+dbname+'.OINV T0 inner join '+dbname+'.RCT2 T1 on T0."DocEntry"=T1."DocEntry" '+
	    'inner join '+dbname+'.ORCT T2 on T2."DocEntry"=T1."DocNum" '+
        'where T0."U_AB_CODCON" = \''+consolidado+'\' and T2."Canceled"=\'N\'';
