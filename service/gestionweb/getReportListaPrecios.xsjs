...
try{
    ...
    var prov = $.request.parameters.get('prov');
	...
	'"revision","comentarios" ,  "UniNegocio", "desUniN", "codProv", "desProv"'+
...
'select "codigo","nombre","unidad", '+
	...
	'"Stock","revision","comentarios",  "UniNegocio", "desUniN", "codProv", "desProv" '+
'from( '+
'select distinct oi."ItemCode" as "codigo",oi."ItemName" as "nombre", oi."InvntryUom" as "unidad",op."ListName" , '+
				...
				'oi."ValidComm" as "comentarios", oi."U_AB_UNPROV" as  "UniNegocio", '+
				'(select distinct "Name" from B1H_AB_PROD."@AB_UNPROV" where "Code" =  oi."U_AB_UNPROV")  as "desUniN",'+
				'oi."U_AB_CODPROV" as  "codProv",'+
				'(select distinct "U_AB_PROVEEDOR" from B1H_AB_PROD."@AB_UNPROV" where "U_AB_CODPROV" = right( oi."U_AB_CODPROV",11))  as "desProv" '+
		...
		'and op."U_AB_SUCURSAL"=\''+suc+'\'and oi."frozenFor" = \'N\' and  right( oi."U_AB_CODPROV",11)=\''+prov+'\' '+ 
		'and ow."Locked"  = \'N\' and oi."ItemType"=\'I\' '+
')Q '+ 
'group by "codigo","nombre","unidad","Stock","revision","comentarios", "desUniN", "UniNegocio", "codProv", "desProv" '+
')Q1  ';
