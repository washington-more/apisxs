...
try{
    ...
    if (empId !== undefined)
	{
        ...
        query ='select * from('+
        'select T0."CardCode"||T0."CardName" as "busqueda",T0."CardCode",T0."CardName",T0."CreateDate",T1."PymntGroup",T2."GroupName" '+
        ...
        'where T0."U_AB_SUCURSAL"=\''+suc+'\' and T0."CardType"=\'C\''+
        'union all '+
        'select T0."CardCode"||T0."CardName" as "busqueda",T0."CardCode",T0."CardName",T0."CreateDate",T1."PymntGroup",T2."GroupName" '+
        'From ' + dbname + '.OCRD T0 inner join ' + dbname + '.OCTG T1 on T0."GroupNum"=T1."GroupNum" '+
	    'inner join ' + dbname + '.OCRG T2 on T0."GroupCode"=T2."GroupCode" '+
        'where T0."U_AB_SUCURSAL"=\'TD\' and T0."CardType"=\'C\' '+
        ')Q where "busqueda" like \'%'+desc+'%\' ';
