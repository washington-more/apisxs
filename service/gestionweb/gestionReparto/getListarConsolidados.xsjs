...
try{
	...
	{ 
        ...
        query = 'select distinct T0."Code" as "Codigo",case when T0."U_AB_CCET"=\'Y\' then \'SI\' else \'NO\' end as "Abierto", '+
        ...
        'T0."U_AB_CCPS" as "Peso",T0."U_AB_CCCP" as "CapacidadPeso",T0."U_AB_CCTP" as "Pedidos",T0."U_AB_CCTK" as "Clientes",T0."U_AB_CCCT" as "TotalContado", '+
        'T0."U_AB_CCKT" as "TotalCredito", '+
        'ifnull((select T11."U_MSSM_USR" from '+dbname+'."@SYP_VEHICU" T9 '+
                'JOIN '+dbname+'."OSLP" T10 on T9."U_AB_CODCHO" = T10."U_AB_DOCIDE" '+
                'JOIN '+dbname+'."@MSSM_CVE" T11 on T10."SlpCode" = T11."Code" '+
                'where T9."U_AB_SUCU"=\''+suc+'\' and T9."Code"= T2."U_AB_DCCV"),\'\') as "IDUsuario", '+
        'ifnull(T0."U_AB_CCRL",\'\') as "responsable" '+
