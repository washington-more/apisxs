    ...
    if (empId !== undefined)
	{
       ...
       query='  with "Sucursales" as ( '+
        ...
        'ifnull((  SELECT GV."Code" || \'-\' ||GV."Name"  FROM ' + dbname + '."@AB_UNPROV" GV '+
            ...
            '),\'\') as "Unidad" '+
        'from ' + dbname + '."@AB_DUUC" T0 WHERE T0."U_AB_DUCU"=\'N\''+
        'union all '+
        ...
        'ifnull((  SELECT GV."Code" || \'-\' ||GV."Name" FROM ' + dbname + '."@AB_UNPROV" GV '+
                ...
                '),\'\') as "Unidad" '+
        'from ' + dbname + '."@AB_DCST" T0 WHERE T0."U_AB_DTCU"=\'N\''+
        ...
        'ifnull((  SELECT GV."Code" || \'-\' ||GV."Name" FROM ' + dbname + '."@AB_UNPROV" GV '+
                ...
                '),\'\') as "Unidad" '+
        'from ' + dbname + '."@AB_DCCE" T0 WHERE T0."U_AB_DCCU"=\'N\' '+
        ...
        '),(ifnull((  SELECT GV."Code" || \'-\' ||GV."Name" as "cadena" FROM ' + dbname + '."@AB_UNPROV" GV '+
                ...
                '),\'\'))'+
        ') as "Unidad" '+
        'from ' + dbname + '."@AB_DTBO" T0 WHERE T0."U_AB_DTBU"=\'N\' '+
