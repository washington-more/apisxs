 ...
 //**************************  MODIFICADO  **********************************************************/
	...
	{ 
       ...
       ' ifnull((  SELECT GV."Name" FROM ' + dbname + '."@AB_UNPROV" GV '+
        ...
        'from ' + dbname + '."@AB_BUU" T0 WHERE T0."U_AB_BUIW"=\'N\''+
       ...
       'ifnull((select STRING_AGG(T1."U_AB_DTCCB" ||\'-\'|| T1."U_AB_DTCDB", \'/\') from ' + dbname + '."@AB_DTCO" T1 where T1."Code"=T0."Code" group by T1."Code"),\'\') as "Obsequido" '+
        'from ' + dbname + '."@AB_BCTC" T0 WHERE T0."U_AB_BTCU"=\'N\' '+
       ...
       'ifnull((  SELECT GV."Name" FROM ' + dbname + '."@AB_UNPROV" GV '+
        ...
        'from ' + dbname + '."@AB_BTCE" T0 WHERE T0."U_AB_BCEU"=\'N\''+
        ...
        'from ' + dbname + '."@AB_BOBE" T0 WHERE T0."U_AB_BBEU"=\'N\'' +
        'union all '+ 
